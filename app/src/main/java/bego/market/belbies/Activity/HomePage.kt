...
class HomePage : AppCompatActivity() {
    ...
    private val BLUETOOTH_PERMISSION_CODE = 104
    private val BLUETOOTH_ADMIN_PERMISSION_CODE = 105
    private val ACCESS_FINE_LOCATION_PERMISSION_CODE = 106
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkPermissions(Manifest.permission.BLUETOOTH, BLUETOOTH_PERMISSION_CODE)
        checkPermissions(Manifest.permission.BLUETOOTH_ADMIN, BLUETOOTH_ADMIN_PERMISSION_CODE)
        checkPermissions(
