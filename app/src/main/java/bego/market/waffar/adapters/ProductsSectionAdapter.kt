...
class ProductsSectionAdapter @Inject constructor(val context: Application) : RecyclerView.Adapter<ProductsSectionAdapter.ChooseSectionViewHolder>( ) {

    var onProductClick: ((id: String) -> Unit)? = null
    var onCartButtonClick: ((allProduct: AllProduct) -> Unit)? = null
